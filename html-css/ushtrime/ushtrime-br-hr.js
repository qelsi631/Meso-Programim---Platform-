...
const LESSON_ID = "l10"; // br/hr exercise
...
<h2>Workshop për Fillestarë</h2>
<p>Rr. Dardania 12<br>Prishtinë<br>Kosovë</p>
...
function validate(userHtml) {
  ...
  const brCount = doc.getElementsByTagName("br").length;
  const hrCount = doc.getElementsByTagName("hr").length;
...
function initMonaco() {
  ...
  require(["vs/editor/editor.main"], () => {
    ...
    updateChecklist({ br: false, hr: false });
    setStatus("Ready");
  });
}
...
function showContinue() {
  ...
  continueBtn.addEventListener("click", async (e) => {
    ...
    window.location.href = "../../html-css/mesimet/lesson0.05.html";
  }, { once: true });
}
