...
const LESSON_ID = "l11"; // HTML Comments exercise
...
<h2>Galeria ime</h2>
<p>Kjo faqe tregon disa foto të preferuara.</p>
...
function validate(userHtml) {
  ...
  const commentCount = countComments(doc);
...
function initMonaco() {
  ...
  require(["vs/editor/editor.main"], () => {
    ...
    updateChecklist({ comments: false, h2: false, p: false });
    setStatus("Ready");
  });
}
